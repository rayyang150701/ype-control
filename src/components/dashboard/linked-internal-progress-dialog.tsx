                    ...
                    {actionItems.map((item) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {item.notes && (
                            <div className="text-slate-700 bg-slate-50/90 p-2 rounded border border-slate-200/70 leading-relaxed text-xs">
                              <span className="font-semibold text-slate-800 block mb-0.5">📝 歷程說明：</span>
                              <div className="whitespace-pre-wrap break-words max-h-40 overflow-y-auto pr-1 text-slate-600 select-text">
                                {item.notes}
                              </div>
                            </div>
                          )}

                          {/* Lesson Learnt (需求1: 支援換行與上下滾動顯示) */}
                          {item.lessonLearnt && (
                            <div className="text-amber-950 bg-amber-50/80 p-2 rounded border border-amber-200/80 leading-relaxed text-xs mt-1">
                              <span className="font-semibold text-amber-950 block mb-0.5">💡 經驗檢討 (Lesson Learnt)：</span>
                              <div className="whitespace-pre-wrap break-words max-h-32 overflow-y-auto pr-1 text-amber-900 select-text">
                                {item.lessonLearnt}
                              </div>
                            </div>
                          )}
